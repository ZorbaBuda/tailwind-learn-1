...
export const headerData = {
  logo: '/img/pruinboom/logo-pruimboom-institute.svg',
};
...
export const howCanHelp = {
  ...
  images: [
    "/img/pruinboom/body/ilustracio-body-part1.svg",
    "/img/pruinboom/body/ilustracio-body-part2.svg",
    "/img/pruinboom/body/ilustracio-body-part3.svg",
    "/img/pruinboom/body/ilustracio-body-part4.svg",
  ],
};
...
export const academicOfferings = {
  ...
  items: [
    {
      img: '/img/pruinboom/masters/couses-blob-mascara.png',
      name: "Courses",
...
export const chiefPresentation = {
  image: "/img/pruinboom/leo-pruimboom.jpg",
  info: {
...
export const footerData = {
  ...
  accreditedBy: {
    title: "Accredited by",
    subitems: [
     "/img/pruinboom/logos/pniEurope.png ",
       "/img/pruinboom/logos/universidadSalamanca.png"
      ],
  },

  collaborationWith: {
    title: "In collaboration with:",
    subitems: ["/img/pruinboom/logos/UGR.png"],
  },
};
